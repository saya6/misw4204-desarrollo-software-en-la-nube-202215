...
def upgrade():
    ...
    sa.Column('file_format', sa.Enum('MP3', 'WAV', 'WMA', name='conversiontaskformats'), nullable=False),
    sa.Column('file_new_format', sa.Enum('MP3', 'WAV', 'WMA', name='conversiontaskformats'), nullable=False),
